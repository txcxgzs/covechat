...
export const wasm_mls_refresh_key_package: (a: number, b: number) => [number, number, number, number];
export const wasm_mls_remove_member: (a: number, b: number, c: number, d: number, e: number) => [number, number, number, number];
